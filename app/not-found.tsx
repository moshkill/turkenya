...
export default function NotFound() {
  return (
    <main style={{ background: '#0a0a0a', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', textAlign: 'center', padding: '0 40px' }}>
      <div style={{ fontSize: 'clamp(100px, 15vw, 180px)', fontWeight: 900, color: 'rgba(255,240,0,0.06)', lineHeight: 1, marginBottom: 0, fontFamily: "'Work Sans', sans-serif" }}>404</div>
