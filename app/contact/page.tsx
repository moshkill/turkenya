          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 40 }}>
              {[
                ...
                { label: 'Call / WhatsApp', value: '+254 729 888 666' },
            ...
            <a href="https://wa.me/254729888666" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, background: '#25D366', color: '#fff', padding: '16px 28px', fontWeight: 700, textDecoration: 'none', fontSize: 14, letterSpacing: 1, borderRadius: 100 }}>
