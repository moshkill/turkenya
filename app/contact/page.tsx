      ...
      <section style={{ maxWidth: 1400, margin: '0 auto', padding: '80px 40px 100px' }} className="contact-grid-wrapper">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 60, alignItems: 'start' }} className="contact-grid">
          ...
          <div>
            ...
            <a href="https://wa.me/254722666644" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, background: 'rgba(37,211,102,0.1)', color: '#fff', border: '1px solid rgba(37,211,102,0.28)', backdropFilter: 'blur(4px) saturate(150%)', WebkitBackdropFilter: 'blur(4px) saturate(150%)', boxShadow: '0 8px 30px rgba(0,0,0,0.22), inset 0 1px 0 rgba(255,255,255,0.12)', padding: '16px 28px', fontWeight: 700, textDecoration: 'none', fontSize: 15, letterSpacing: 1, borderRadius: 100 }}>
