  ...
  return (
    <main style={{ background: '#0a0a0a', minHeight: '100vh', color: '#fff' }}>
      ...
      <section style={{ position: 'relative', height: '50vh', minHeight: 360, overflow: 'hidden' }}>
        <img src="/images/contact.jpg" alt="" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover' }} className="parallax-img" />
      ...
      <section style={{ maxWidth: 1400, margin: '0 auto', padding: '80px 40px 100px' }} className="contact-grid-wrapper">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 60, alignItems: 'start' }} className="contact-grid">
          ...
          <div>
            ...
            <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: 16, marginBottom: 40, lineHeight: 1.7 }}>Based in Nairobi, serving clients across Kenya, East Africa, and the diaspora worldwide.</p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 40 }}>
              {[
                ...
                <div key={item.label} style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 12, padding: '18px 20px' }}>
                  ...
                  <div style={{ fontSize: 16, color: 'rgba(255,255,255,0.7)', whiteSpace: 'pre-line', lineHeight: 1.6 }}>{item.value}</div>
                </div>
              ))}
            </div>

            <a href="https://wa.me/254722666644" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, background: 'rgba(37,211,102,0.18)', color: '#fff', border: '1px solid rgba(37,211,102,0.28)', backdropFilter: 'blur(4px) saturate(150%)', WebkitBackdropFilter: 'blur(4px) saturate(150%)', boxShadow: '0 8px 30px rgba(0,0,0,0.22), inset 0 1px 0 rgba(255,255,255,0.12)', padding: '16px 28px', fontWeight: 700, textDecoration: 'none', fontSize: 15, letterSpacing: 1, borderRadius: 100 }}>
