        ...
        <Link href={'/blog/' + featured.slug} className="hover-lift" style={{ display: 'block', position: 'relative', borderRadius: 20, overflow: 'hidden', height: 480, textDecoration: 'none', color: 'white' }}>
          ...
          <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: 48 }}>
            <div style={{ display: 'flex', gap: 10, marginBottom: 16 }}>
              <span style={{ background: 'rgba(255,240,0,0.13)', color: '#fff', border: '1px solid rgba(255,240,0,0.42)', backdropFilter: 'blur(14px) saturate(180%)', WebkitBackdropFilter: 'blur(14px) saturate(180%)', boxShadow: '0 8px 30px rgba(0,0,0,0.22), inset 0 1px 0 rgba(255,255,255,0.18)', padding: '5px 14px', fontSize: 10, fontWeight: 800, letterSpacing: 2, borderRadius: 100 }}>FEATURED</span>
            ...
            <Link key={p.slug} href={'/blog/' + p.slug} className="hover-lift" style={{ textDecoration: 'none', color: 'white', background: 'rgba(255,255,255,0.03)', borderRadius: 20, overflow: 'hidden', border: '1px solid rgba(255,255,255,0.06)', display: 'block' }}>
              <div style={{ height: 220, overflow: 'hidden', position: 'relative' }}>
                ...
                <div style={{ position: 'absolute', top: 16, left: 16 }}>
                  <span style={{ background: 'rgba(255,240,0,0.13)', color: '#fff', border: '1px solid rgba(255,240,0,0.42)', backdropFilter: 'blur(14px) saturate(180%)', WebkitBackdropFilter: 'blur(14px) saturate(180%)', boxShadow: '0 8px 30px rgba(0,0,0,0.22), inset 0 1px 0 rgba(255,255,255,0.18)', padding: '4px 12px', fontSize: 10, fontWeight: 800, letterSpacing: 1.5, borderRadius: 100 }}>{p.cat}</span>
                </div>
              </div>
