...
export default function Footer() {
  return (
    <footer style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(180deg, #060606 0%, #070707 62%, #090806 100%)', fontFamily: "'Abel', system-ui, sans-serif" }}>
      {/* warm dusk horizon glow — keeps the base from reading as flat black */}
      <div aria-hidden style={{ position: 'absolute', left: 0, right: 0, bottom: 0, height: 380, pointerEvents: 'none', zIndex: 0, background: 'radial-gradient(125% 100% at 50% 100%, rgba(255,240,0,0.05) 0%, rgba(255,240,0,0.018) 32%, transparent 62%)' }} />
      ...
      <svg aria-hidden viewBox="0 0 1440 320" preserveAspectRatio="xMidYMax slice" style={{ position: 'absolute', left: 0, right: 0, bottom: 0, width: '100%', height: 320, zIndex: 0, pointerEvents: 'none' }}>
        <defs>
          <linearGradient id="savFade" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#fff000" stopOpacity="0.015" />
            <stop offset="100%" stopColor="#fff000" stopOpacity="0.07" />
          </linearGradient>
          <linearGradient id="savFadeSoft" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#FFDC3E" stopOpacity="0.008" />
            <stop offset="100%" stopColor="#FFDC3E" stopOpacity="0.035" />
          </linearGradient>
        </defs>
        {/* distant hill */}
...
IATA Travel Agent &middot; KATA Member &middot; Nairobi, Kenya
          </p>
        </div>
      </div>
    </footer>
