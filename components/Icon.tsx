...
export type IconName =
  ...
  | 'briefcase' | 'building' | 'bed' | 'heart-pulse' | 'camera' | 'ship'
  | 'phone' | 'mail' | 'message' | 'whatsapp' | 'shield' | 'award' | 'file-text' | 'sun' | 'wallet'
...
const P: Record<IconName, React.ReactNode> = {
  ...
  whatsapp: <><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z" /><path d="M9.5 9.5c0 3 2 5 5 5" /></>,
...
export default function Icon({ name, size = 20, stroke = 2, style, className }: { name: IconName; size?: number; stroke?: number; style?: React.CSSProperties; className?: string }) {
  return (
    <svg
