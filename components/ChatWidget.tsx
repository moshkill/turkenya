      ...
      {open && (
        <div style={{ position: 'absolute', bottom: 70, right: 0, display: 'flex', flexDirection: 'column', gap: 10, alignItems: 'flex-end' }}>
          <a href={WA} target="_blank" rel="noreferrer" onClick={() => setOpen(false)} style={{
            ...
            background: 'rgba(37,211,102,0.1)', color: '#fff', border: '1px solid rgba(37,211,102,0.28)', backdropFilter: 'blur(4px) saturate(150%)', WebkitBackdropFilter: 'blur(4px) saturate(150%)', padding: '12px 20px', borderRadius: 100,
