  ...
  return (
    <div className="mobile-action-bar">
      <a
        ...
        style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, background: '#25D366', color: '#fff', padding: '13px', borderRadius: 12, fontSize: 14, fontWeight: 700, textDecoration: 'none' }}
      >
